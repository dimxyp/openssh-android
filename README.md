...
│   ├── terminal/ # ExtraKeysBar (extra-keys/edit-mode bar) + terminal key mappings
...
- Full ANSI/VT100 terminal emulation (the terminal currently streams raw shell text; a proper VT100/xterm emulator is a follow-up).
- Port forwarding.
